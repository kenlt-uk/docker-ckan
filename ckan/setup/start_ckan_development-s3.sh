...
paster --plugin=ckan config-tool $APP_DIR/production.ini \
  "ckan.datagovsg_s3_resources.s3_aws_access_key_id = $CKAN_S3_AWS_ACCESS_KEY_ID" \
  "ckan.datagovsg_s3_resources.s3_aws_secret_access_key = $CKAN_S3_AWS_SECRET_ACCESS_KEY" \
  "ckan.datagovsg_s3_resources.s3_bucket_name = $CKAN_S3_BUCKET_NAME" \
  "ckan.datagovsg_s3_resources.s3_url_prefix = $CKAN_S3_URL_PREFIX" \
  "ckan.datagovsg_s3_resources.s3_aws_region_name = $CKAN_S3_AWS_REGION_NAME"

...
ckan config-tool $CKAN_INI -s DEFAULT "debug = $CKAN_DEBUG"
...
ckan config-tool $CKAN_INI \
    ...
    "ckan.harvest.mq.hostname = $CKAN_REDIS_HOSTNAME" \
    "ckan.site_url = $DEV_CKAN_SITE_URL" \
...
PGPASSWORD=$PSQL_PASSWD psql -h $PSQL_DB -U $PSQL_MASTER -d $TEST_CKAN_DB_NAME -c "DROP EXTENSION IF EXISTS postgis CASCADE; DROP TYPE IF EXISTS log_level CASCADE;"
